...
# -------- Ratings --------
echo -e "\nSeeding ratings"
curl -X POST http://localhost:8000/api/v1/products/1/ratings \
   -H 'Content-Type: application/json' \
...
curl -X POST http://localhost:8000/api/v1/products/2/ratings \
   -H 'Content-Type: application/json' \
...
curl -X POST http://localhost:8000/api/v1/products/3/ratings \
   -H 'Content-Type: application/json' \
...
curl -X POST http://localhost:8000/api/v1/products/4/ratings \
   -H 'Content-Type: application/json' \
